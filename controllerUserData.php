...
$errors['contactno'] = "Phone number in not valid!";
}
    ...
    if(count($errors) === 0){
        ...
        $status = "notverified";
        // $insert_data = "INSERT INTO usertable (name, email, contactno, password, code, status)
        ...
        if($data_check){
            ...
            $sender = "From: artempire2324@gmail.com";
