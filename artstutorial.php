...
<div class="containervideo">
  ...
  <div class="main-video-containervideo">
    <video width="10cm" class="main-video" src="img/vid-1.mp4" loop controls autoplay="false"></video>
  ...
  <div class="video-list1-containervideo">
    ...
    <div class="list1 active">
      <video class="list1__video" src="img/vid-1.mp4"></video>
      <h3 class="list1__title">How to draw pictures using numbers 1 to 10</h3>
    </div>

    <div class="list1">
      <video class="list1__video" src="img/vid-2.mp4"></video>
